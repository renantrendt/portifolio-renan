  ...
  const [careerStages, setCareerStages] = useState([
    {
      ...
      projects: [
        ...
        { name: "Mentors", url: "#", description: "Mochary Method (CEO coach of OpenAI, Coinbase, Brex... Coach: Nancy Xu); Wes Bush (Creator of product led growth); Chris Saad (ex-Uber growth)" }
      ]
    },
    {
      id: '1',
