...
export default function Home() {
  ...
  const [careerStages, setCareerStages] = useState([
    ...
    },
    {
      ...
      description: "",
      projects: [
        { name: "PinUnfold", url: "https://www.canva.com/design/DAGiD0-0RxQ/UGKa521OIMALt4WGQpQV8Q/edit", description: "The primary role of a fashion designer is to translate haute-couture collections into ready-to-wear products. With AI, this task can be enhanced. Similar to vibe coding, I am developing a fashion IDE, which is a Chrome extension within Pinterest." },
    ...
    },
    {
      ...
      projects: [
        ...
        { name: "Microbiological Research", url: "https://www.canva.com/design/DAGhrwP_4HI/qFxDYnLAWSholEU_djXRzg/edit", description: "Leading the development of patents to treat recurrent vulvovaginal candidiasis." },
